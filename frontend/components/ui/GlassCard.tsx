...
const glowMap = {
  ...
  blue: "group-hover:shadow-[0_0_40px_rgba(59,130,246,0.15)] hover:border-blue-500/30",
  purple: "group-hover:shadow-[0_0_40px_rgba(139,92,246,0.15)] hover:border-purple-500/30",
...
export function GlassCard({ children, className, glowColor = "cyan" }: GlassCardProps) {
  return (
    <motion.div
      ...
      className={cn(
        "group relative rounded-[32px] border border-white/5 bg-[#0B1120]/80 p-6 backdrop-blur-md overflow-hidden transition-all duration-500",
        glowMap[glowColor],
        className
      )}
    >
